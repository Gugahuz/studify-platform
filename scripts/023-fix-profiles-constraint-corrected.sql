-- Fix profiles foreign key constraint for testing environment (CORRECTED VERSION)
...
-- Verify the setup (FIXED UUID COMPARISON)
DO $$
DECLARE
...
BEGIN
    -- Fixed: Use IN clause instead of LIKE for UUID comparison
    SELECT COUNT(*) INTO profile_count FROM profiles WHERE id IN (
        '00000000-0000-0000-0000-000000000001'::uuid,
        '00000000-0000-0000-0000-000000000002'::uuid,
        '00000000-0000-0000-0000-000000000003'::uuid
    );
