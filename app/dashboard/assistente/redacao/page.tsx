  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Professor de redação</h1>
          <p className="text-gray-600">Melhore suas habilidades de escrita</p>
        </div>
      </div>
      ...
      <Card className="border-indigo-100">
        ...
        <CardContent>
          <div className="text-center py-12">
            <PenTool className="h-16 w-16 text-indigo-300 mx-auto mb-4" />
