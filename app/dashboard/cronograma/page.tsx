                    ...
                    {timeSlots.map((slot) => (
                      <tr key={slot.time} className="h-12">
                        ...
                        {WEEK_DAYS.map((day) => {
                          ...
                          // Find if there's a class that starts at this time
                          ...
                          // Check if this cell is part of an ongoing class
                          ...
                          // If there's a class starting at this time, render it with rowspan
                          if (classAtThisTime) {
                          ...
                          // If this cell is part of an ongoing class, don't render (covered by rowspan)
                          if (ongoingClass && ongoingClass !== classAtThisTime) {
                            return null
                          }

                          // Empty cell - clickable to add new class
                          return (
                            <td
